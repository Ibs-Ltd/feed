...
class _GlobalCalendarPageState extends State<GlobalCalendarPage> {
  ...
  List<EventItem> itemList = [
    EventItem("assets/images/image1.png","In 3 Minutes","Nirastate"),
    EventItem( "assets/images/image2.png","In 3 Hours","Atica"),
    EventItem( "assets/images/image3.png","In 5 Minutes","Zootv"),
    EventItem( "assets/images/image4.png","In 20 Minutes","Kyan"),
    EventItem("assets/images/image5.png","In 2 Hours","Random"),
    EventItem("assets/images/image1.png","In 3 Minutes","Nirastate"),
    EventItem( "assets/images/image2.png","In 3 Hours","Atica"),
    EventItem( "assets/images/image3.png","In 5 Minutes","Zootv"),
    EventItem( "assets/images/image4.png","In 20 Minutes","Kyan"),
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: AppTextView(text: itemList[index].companyName,size:10,fontWeight: FontWeight.bold,color: AppColors.appBlack,),
                          ),
                          Card(
...
class EventItem{
  ...
  EventItem(this.url, this.time,this.companyName);
}